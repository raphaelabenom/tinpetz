...
class LightModeTheme extends FlutterTheme {
  late Color primaryColor = const Color(0xFF4A4869);
  late Color secondaryColor = const Color(0xFF9B97BD);
  ...
  late Color secondaryText = const Color(0xFF8582A7);
...
class DarkModeTheme extends FlutterTheme {
  late Color primaryColor = const Color(0xFF373656);
  late Color secondaryColor = const Color(0xFF9B97BD);
  late Color tertiaryColor = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF1A1F24);
